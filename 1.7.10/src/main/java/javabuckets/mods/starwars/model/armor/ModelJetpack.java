...
public class ModelJetpack extends ModelBiped
{
	...
	public ModelJetpack(float f)
	{
		...
		this.bipedBody.addChild(pack);
		this.bipedBody.addChild(tankleft);
		this.bipedBody.addChild(tankmiddle);
		this.bipedBody.addChild(tankright);
		this.bipedBody.addChild(toptankleft);
		this.bipedBody.addChild(toptankmiddle);
		this.bipedBody.addChild(toptankright);
		this.bipedBody.addChild(engineleft);
		this.bipedBody.addChild(engineright);
		this.bipedBody.addChild(tankmiddle_part);
	}
