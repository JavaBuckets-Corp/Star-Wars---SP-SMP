...
{	
	...
	public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4)
	{
		...
		{
			par3List.add("Ammo: " + (50 - par1ItemStack.getTagCompound().getInteger("ammoUsed")) + "/50");
		}
		else
		{
			par3List.add("Ammo: 50/50");
		}
	}
	...
	public boolean onEntitySwing(EntityLivingBase entityLiving, ItemStack stack)
	{
		...
		{
			if (stack.getTagCompound().getInteger("ammoUsed") < 50)
			{
	...
	{		
		if (par1ItemStack.hasTagCompound())
		{
			if (par1ItemStack.getTagCompound().getInteger("ammoUsed") >= 50 && par3EntityPlayer.inventory.hasItem(Item.getItemFromBlock(Blocks.redstone_block)))
			{
