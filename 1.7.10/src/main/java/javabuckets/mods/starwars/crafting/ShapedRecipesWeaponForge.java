...
public class ShapedRecipesWeaponForge implements IRecipe
{
	...
	public ShapedRecipesWeaponForge(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
	{
	...
	public ShapedRecipesWeaponForge func_92100_c()
	{
